package com.weg.oficinactw.monolitico;
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                case 1: // SINALIZAR PROBLEMA
                    System.out.print("Seu Nome: "); String q = sc.nextLine();
                    System.out.print("Equipamento com defeito: "); String e = sc.nextLine();
                    System.out.print("Descrição do problema: "); String d = sc.nextLine();
                    System.out.println("\n[REGISTRO]: " + q + " sinalizou falha no equipamento " + e + ".");
                    break;

                case 2: // ABRIR OS (Professor)
                    System.out.print("Digite seu ID de Professor: "); int idProf = sc.nextInt();
                ...
                case 3: // EXECUTAR (Alunos)
                    System.out.print("ID da OS: "); int idEx = sc.nextInt() - 1;
                    System.out.print("Seu ID de Aluno: "); int idAlu = sc.nextInt();
                    boolean autorizado = false;

                    for(int i=0; i<3; i++) {
                        if(osAlunosEscalados[idEx][i] == idAlu) autorizado = true;
                    }
                ...
                case 4: // APROVAR (Professor)
                    System.out.print("ID da OS: "); int idAp = sc.nextInt() - 1;
                    System.out.print("ID do Professor: "); int idPrAp = sc.nextInt();
